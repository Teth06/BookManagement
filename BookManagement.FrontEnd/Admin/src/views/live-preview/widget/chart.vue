 ...
 <!--     <BCol lg="6">
        <BCard no-body>
          ...
          <BCardBody>
            ...
            <apexchart
              ...
              height="250"
              dir="ltr"
              :series="userActivitiesChart.series"
              :options="userActivitiesChart.chartOptions"
            ></apexchart>
          </BCardBody>
        </BCard>
      </BCol>
        ...
        <BCard no-body>
          <BCardHeader class="d-flex align-items-center justify-content-between">
            ...
            <BDropdown
              ...
              aria-haspopup="true"
              :offset="{ alignmentAxis: -160, crossAxis: 0, mainAxis: 0 }"
            >
              <template #button-content
                ><span class="text-muted"
                  ><i class="material-icons-two-tone f-18">more_vert</i></span
                >
              </template>
          ...
          <BCardBody>
            ...
            <apexchart
              ...
              height="250"
              dir="ltr"
              :series="yearlySummeryChart.series"
              :options="yearlySummeryChart.chartOptions"
            ></apexchart>
          </BCardBody>
        </BCard>
      </BCol>-->
      <BCol lg="6">
        <BCard no-body>
          ...
          <BCardBody>
            <div
              class="d-sm-flex align-items-center justify-content-between flex-wrap gap-2"
            >
              <div class="d-flex align-items-center mb-2 mb-sm-0">
                <h3 class="mb-0 me-1">$ 82.99</h3>
                <span class="badge bg-success"
                  ><i class="ti ti-arrow-narrow-up"></i> 2.6%</span
                >
              </div>
...
<!--      <BCol md="6" xl="4">
        <BCard no-body>
          <BCardHeader class="d-flex align-items-center justify-content-between">
            <h5>Total Sales</h5>
            <i
              class="ph-duotone ph-info f-20 ms-1"
          ...
          <BCardBody>
            ...
            <div
              class="d-flex align-items-center justify-content-between mt-4 mb-3 flex-wrap"
            >
            ...
            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap">
              ...
              <div class="d-flex align-items-center">
                ...
                <span class="badge bg-light-danger"
                  ><i class="ti ti-arrow-narrow-down"></i> 2.6%</span
                >
              </div>
            </div>
        ...
        <BCard no-body>
          <BCardBody>
            <div class="d-flex align-items-center justify-content-between">
              ...
              <i
                class="ph-duotone ph-arrow-square-out f-20 ms-1"
                data-bs-toggle="tooltip"
                data-bs-title="Your team performance"
              ></i>
            </div>
            <select class="form-select form-select-sm w-auto border-0 shadow-none">
              <option>Today</option>
            ...
            <div class="text-center">
              ...
              <div class="d-inline-flex align-items-center m-1">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-primary f-12"></i> Completed
                </p>
                <span class="badge bg-light-secondary ms-1">56</span>
              </div>
              <div class="d-inline-flex align-items-center m-1">
                <p class="mb-0">
                  <i class="ph-duotone ph-circle text-secondary f-12"></i> Percentage
                </p>
        ...
        <BCard no-body>
          ...
          <BCardBody>
            ...
            <apexchart
              ...
              height="150"
              dir="ltr"
              :series="overviewChart2.series"
              :options="overviewChart2.chartOptions"
            ></apexchart>
            <div
              class="bg-body mt-3 py-2 px-3 rounded d-flex align-items-center justify-content-between"
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-danger f-12"></i> Apps
              </p>
              <h5 class="mb-0 ms-1">10+</h5>
            </div>
            <div
              class="bg-body mt-1 py-2 px-3 rounded d-flex align-items-center justify-content-between"
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-primary f-12"></i> Other
              </p>
            ...
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-purple-500 f-12"></i> Widgets
              </p>
            ...
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-success f-12"></i> Forms
              </p>
            ...
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-warning f-12"></i> Components
              </p>
            ...
            >
              <p class="mb-0">
                <i class="ph-duotone ph-circle text-info f-12"></i> Pages
              </p>
              <h5 class="mb-0 ms-1">150+</h5>
            </div>
          </BCardBody>
            ...
            <BRow class="row align-items-center">
              ...
              <BCol class="col-7">
                ...
                <apexchart
                  ...
                  :options="transactionChart.chartOptions"
                ></apexchart>
              </BCol>
            </BRow>
          </BCardBody>
                ...
                <BRow class="align-items-center">
                  ...
                  <BCol cols="7">
                    ...
                    <apexchart
                      ...
                      height="40"
                      dir="ltr"
                      :series="timeSpentChart.series"
                      :options="timeSpentChart.chartOptions"
                    >
                    </apexchart>
                  </BCol>
                </BRow>
                ...
                <BRow class="align-items-center">
                  ...
                  <BCol cols="6">
                    ...
                    <apexchart
                      ...
                      height="60"
                      dir="ltr"
                      :series="newVisitorChart.series"
                      :options="newVisitorChart.chartOptions"
                    >
                    </apexchart>
                  </BCol>
                </BRow>
            ...
            <BCard no-body>
              <BCardBody>
                ...
                <apexchart
                  ...
                  height="100"
                  dir="ltr"
                  :series="totalRewardsChart.series"
                  :options="totalRewardsChart.chartOptions"
                ></apexchart>
              </BCardBody>
            </BCard>
          </BCol>
            ...
            <BCard no-body>
              <BCardBody>
                ...
                <apexchart
                  ...
                  height="100"
                  dir="ltr"
                  :series="totalRewardsChart2.series"
                  :options="totalRewardsChart2.chartOptions"
                ></apexchart>
              </BCardBody>
            </BCard>
          </BCol>
            ...
            <BRow class="align-items-center justify-content-center">
              <BCol md="6" xl="4" class="my-2">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <p class="mb-0 text-muted">
                    <i class="ph-duotone ph-caret-up f-20 align-bottom text-success"></i>
                    0.73%
                  </p>
                </div>
                <div class="mt-1 row align-items-center">
                  ...
                  <BCol cols="6">
                    ...
                    <apexchart
                      ...
                      height="40"
                      dir="ltr"
                      :series="bitcoinChart1.series"
                      :options="bitcoinChart1.chartOptions"
                    >
                    </apexchart>
                  </BCol>
                </div>
              ...
              <BCol md="6" xl="4" class="my-2">
                <div class="d-flex align-items-center justify-content-between">
                  <p class="mb-0 me-1">Bitcoin</p>
                  <p class="mb-0 text-muted">
                    <i class="ph-duotone ph-caret-down f-20 align-bottom text-danger"></i>
                    0.73%
                  </p>
                </div>
                <div class="mt-1 row align-items-center">
                  ...
                  <BCol cols="6">
                    ...
                    <apexchart
                      ...
                      height="40"
                      dir="ltr"
                      :series="bitcoinChart2.series"
                      :options="bitcoinChart2.chartOptions"
                    >
                    </apexchart>
                  </BCol>
                </div>
              ...
              <BCol md="6" xl="4" class="my-2">
                <div class="d-flex align-items-center justify-content-between">
                  <p class="mb-0 me-1">Bitcoin</p>
                  <p class="mb-0 text-muted">
                    <i class="ph-duotone ph-caret-up f-20 align-bottom text-primary"></i>
                    0.73%
                  </p>
                </div>
                <div class="mt-1 row align-items-center">
                  ...
                  <BCol cols="6">
                    ...
                    <apexchart
                      ...
                      height="40"
                      dir="ltr"
                      :series="bitcoinChart3.series"
                      :options="bitcoinChart3.chartOptions"
                    >
                    </apexchart>
                  </BCol>
                </div>
              ...
              <BCardBody>
                <div class="my-n4 text-center mx-auto" style="max-width: 130px">
                  ...
                  <apexchart
                    ...
                    height="150"
                    dir="ltr"
                    :series="totalEarningChart1.series"
                    :options="totalEarningChart1.chartOptions"
                  >
                  </apexchart>
                </div>
              </BCardBody>
              ...
              <BCardBody>
                <div class="my-n4 text-center mx-auto" style="max-width: 130px">
                  ...
                  <apexchart
                    ...
                    height="150"
                    dir="ltr"
                    :series="totalEarningChart2.series"
                    :options="totalEarningChart2.chartOptions"
                  >
                  </apexchart>
                </div>
              </BCardBody>
